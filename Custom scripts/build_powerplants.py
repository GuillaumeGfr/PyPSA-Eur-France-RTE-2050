...
if __name__ == "__main__":
    ...
    ###Edit for RTE 2050: Bypass original ppl logic and uses custom poperplants data
    ### Always use the file specified via input.RTE_powerplants
    logger.info(f"🔍 Using custom powerplants from {snakemake.input.RTE_powerplants}")
    ppl = pd.read_csv(snakemake.input.RTE_powerplants, dtype={"bus": "str"})
