...
rule build_powerplants:
    ...
    input:
        ...
        RTE_powerplants = lambda wildcards: f"data/powerplants_rte/powerplants_{config['run']['name']}.csv" 
    output:
...
rule add_electricity:
    ...
    input:
        ...
        load=resources("electricity_demand_base_s.nc"),
        busmap=resources("busmap_base_s_{clusters}.csv"),
        rte_regions_path="data/RTE_regions.csv",
        flexibility_technologies="data/flexibility.csv"
    output:
